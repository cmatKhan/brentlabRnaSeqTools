...
write_csv(induction_set_tally, "/home/chase/projects/brentlab/daily_work/20210211_induction_set_tally_with_database/induction_experiment_table/data/genotype_tally.csv")
```
...
write_csv(table_vis_meta_qual, '/home/chase/projects/brentlab/daily_work/20210211_induction_set_tally_with_database/induction_experiment_table/data/sample_detail_meta_qual_.csv')
```
...
for(geno in names(induction_set_split)){
  ...
  write_csv(df, paste0('/home/chase/projects/brentlab/daily_work/20210211_induction_set_tally_with_database/induction_experiment_table/data/split_by_genotype/', filename))
}
```
